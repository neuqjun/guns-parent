package com.stylefeng.guns.api.alipay.demo.trade;
...
import com.stylefeng.guns.api.alipay.demo.trade.config.Configs;
import com.stylefeng.guns.api.alipay.demo.trade.model.ExtendParams;
import com.stylefeng.guns.api.alipay.demo.trade.model.GoodsDetail;
import com.stylefeng.guns.api.alipay.demo.trade.model.builder.*;
import com.stylefeng.guns.api.alipay.demo.trade.model.hb.*;
import com.stylefeng.guns.api.alipay.demo.trade.model.result.AlipayF2FPayResult;
import com.stylefeng.guns.api.alipay.demo.trade.model.result.AlipayF2FPrecreateResult;
import com.stylefeng.guns.api.alipay.demo.trade.model.result.AlipayF2FQueryResult;
import com.stylefeng.guns.api.alipay.demo.trade.model.result.AlipayF2FRefundResult;
import com.stylefeng.guns.api.alipay.demo.trade.service.AlipayMonitorService;
import com.stylefeng.guns.api.alipay.demo.trade.service.AlipayTradeService;
import com.stylefeng.guns.api.alipay.demo.trade.service.impl.AlipayMonitorServiceImpl;
import com.stylefeng.guns.api.alipay.demo.trade.service.impl.AlipayTradeServiceImpl;
import com.stylefeng.guns.api.alipay.demo.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.stylefeng.guns.api.alipay.demo.trade.utils.Utils;
import com.stylefeng.guns.api.alipay.demo.trade.utils.ZxingUtils;
...
public class AliPayServiceAPIImpl implements AliPayServiceAPI {
    private static Log                  log = LogFactory.getLog(AliPayServiceAPIImpl.class);
...
/*    public static void main(String[] args) {
    ...
    // 测试当面付2.0查询订单
    @Override
    public PayResultVo test_trade_query(String outTradeNo, String orderId) {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                hashMap.put("orderMsg", "支付成功");
                payResultVo.setData(hashMap);
                return payResultVo;
            case FAILED:
    ...
    // 测试当面付2.0生成支付二维码
    @Override
    public String test_trade_precreate(String totalAmount,String orderId) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        String outTradeNo = "tradeprecreate" + System.currentTimeMillis()
                            + (long) (Math.random() * 10000000L);

        jedis.set(orderId, outTradeNo);
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format("E:\\uploadTest\\qr-%s.png",
